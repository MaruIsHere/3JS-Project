                    ...
                    <div class="mb-3">
                     ...
                     <div class="mb-3">
                        ...
                        <textarea class="form-control @error('information') is-invalid @enderror" 
                                  ...
                                  placeholder="Masukkan deskripsi product">{{ old('information', $product->information) }}</textarea>
                        @error('information')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <select class="form-select @error('category') is-invalid @enderror" id="category" name="category">
                                    ...
                                    <option value="TerumbuKarang" {{ old('category', $product->category) == 'TerumbuKarang' ? 'selected' : '' }}>Terumbu Karang</option>
