...
document.getElementById("scleractinina_coral_indet").appendChild(renderer.domElement);
...
const ambientLight = new THREE.AmbientLight(0x333333, objToRender === "scleractinina_coral_indet" ? 8 : 1);
