...
document.getElementById("scolymia_australis").appendChild(renderer.domElement);
...
const ambientLight = new THREE.AmbientLight(0x333333, objToRender === "scolymia_australis" ? 8 : 1);
