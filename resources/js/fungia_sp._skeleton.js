...
loader.load(`/models/${objToRender}/scene.gltf`, (gltf) => {
   ...
   Fungia sp. (skeleton) merujuk pada rangka (kerangka) karang jamur dari genus Fungia (ordo Scleractinia, famili Fungiidae) yang tidak lagi memiliki jaringan hidup, sehingga identifikasi dilakukan berdasarkan struktur rangka saja.
    `;
