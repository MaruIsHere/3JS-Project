...
// PERBAIKAN: Nilai Z ditingkatkan menjadi 5.0 agar objek terlihat jelas di awal.
camera.position.z = objToRender === "oculina_sp._skeleton" ? 5.0 : 500;
...
const ambientLight = new THREE.AmbientLight(
    0x333333,
    objToRender === "oculina_sp._skeleton" ? 8 : 1
);
